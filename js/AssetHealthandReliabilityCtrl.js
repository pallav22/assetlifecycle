app.controller('AssetHealthandReliabilityCtrl',['$rootScope','$scope','$http','$filter','$modal',function($rootScope,$scope,$http,$filter,$modal){
...
//ESN Dropdown and the Respective Chart
   ...
   $scope.display3="Hide";
    ...
    for(var i=0;i<1;i++)
    {
        $scope.FirstPoint.push($scope.ChartData[i]);
    }
...
//Plot Alert
    for(var i=0;i<$scope.ChartData.length;i++){
        ...
        for(var i=0;i<1;i++){
        $scope.FirstAlertPoint.push($scope.AlertData[i]);
    }
...
//Plot Full SV
    ...
    for(var i=0;i<1;i++){
        $scope.FirstFullSvPoint.push($scope.FullSv[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstQTSVPoint.push($scope.QTSV[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstTailChangePoint.push($scope.TailChange[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstWarrantyPoint.push($scope.Warranty[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstWaterWashPoint.push($scope.WaterWash[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstEventPoint.push($scope.Event[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstThrustRatingChangePoint.push($scope.ThrustRatingChange[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstLLPPoint.push($scope.LLP[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstCMRPoint.push($scope.CMR[i]);
    }
    ...
    for(var i=0;i<1;i++){
        $scope.FirstForecastedSVPoint.push($scope.ForecastedSV[i]);
    }
...
//Plot Future
    ...
    for(var i=0;i<1;i++){
        $scope.FirstFuturePoint.push($scope.FutureData[i]);
    }
        ...
        plotOptions: {
           series: {
            turboThreshold:5000,                       
             ...
             annotationsOptions: {
                    enabledButtons: false
                        ...
                        series: [{
                    name: 'CSN',
                    data: $scope.FirstPoint,

                },{
                    type:'scatter',
                    name:'Alert',
                    data:$scope.FirstAlertPoint,
                    marker: {
                    ...
                    type:'scatter',
                    name:'TailChange',
                    data:$scope.FirstTailChangePoint,
                    marker: {
                    ...
                    type:'scatter',
                    name:'WaterWash',
                    data:$scope.FirstWaterWashPoint,
                    marker: {
                    ...
                    data:$scope.FirstThrustRatingChangePoint,
                    marker: {
                    ...
                    type:'scatter',
                    name:'ForecastedSV',
                    data:$scope.FirstForecastedSVPoint,
                    marker: {
            ...
            ,{
                    ...
                    var series = $scope.chart1.series[0];
                    var series1 = $scope.chart1.series[1];
                    var series2 = $scope.chart1.series[2];
                    var series3 = $scope.chart1.series[3];
                    var series4 = $scope.chart1.series[4];
                    var series5 = $scope.chart1.series[5];
                    var series6 = $scope.chart1.series[6];
                    var series7 = $scope.chart1.series[7];
                    var series8 = $scope.chart1.series[8];
                    var series9 = $scope.chart1.series[9];
                    var series10 = $scope.chart1.series[10];
                    var series11 = $scope.chart1.series[11];
                    var series12 = $scope.chart1.series[12];
                   
                    var count = 1;
                   myVar = setInterval(function(){ $scope.PlotPoints() }, 1000);
                    $scope.PlotPoints=function () {   
                                      
                        if(count < $scope.ChartData.length){
                            series.addPoint({x : $scope.ChartData[count].x, y: $scope.ChartData[count].y, eventID : $scope.ChartData[count].eventID});
                            series1.addPoint({x : $scope.AlertData[count].x, y: $scope.AlertData[count].y, eventID : $scope.AlertData[count].eventID});
                            series12.addPoint({x : $scope.FutureData[count].x, y: $scope.FutureData[count].y, eventID : $scope.FutureData[count].eventID});
                            series2.addPoint({x : $scope.FullSv[count].x, y: $scope.FullSv[count].y, eventID : $scope.FullSv[count].eventID});
                            series3.addPoint({x : $scope.QTSV[count].x, y: $scope.QTSV[count].y, eventID : $scope.QTSV[count].eventID});
                            series4.addPoint({x : $scope.TailChange[count].x, y: $scope.TailChange[count].y, eventID : $scope.TailChange[count].eventID});
                            series5.addPoint({x : $scope.Warranty[count].x, y: $scope.Warranty[count].y, eventID : $scope.Warranty[count].eventID});
                            series6.addPoint({x : $scope.WaterWash[count].x, y: $scope.WaterWash[count].y, eventID : $scope.WaterWash[count].eventID});
                            series7.addPoint({x : $scope.Event[count].x, y: $scope.Event[count].y, eventID : $scope.Event[count].eventID});
                            series8.addPoint({x : $scope.ThrustRatingChange[count].x, y: $scope.ThrustRatingChange[count].y, eventID : $scope.ThrustRatingChange[count].eventID});
                            series9.addPoint({x : $scope.LLP[count].x, y: $scope.LLP[count].y, eventID : $scope.LLP[count].eventID});
                            series10.addPoint({x : $scope.CMR[count].x, y: $scope.CMR[count].y, eventID : $scope.CMR[count].eventID});
                            series11.addPoint({x : $scope.ForecastedSV[count].x, y: $scope.ForecastedSV[count].y, eventID : $scope.ForecastedSV[count].eventID});
  ...
  if(myVar) { clearInterval(myVar); }
   ...
   $scope.position="AtEventChart";
    ...
    for(var i=0;i<$scope.EventData.length;i++){
     ...
     for(var i=0;i<1;i++)
    {
        $scope.FirstCSNPoint.push($scope.ChartDataCSN[i]);
    }
 
    for(var i=0;i<1;i++)
    {
        $scope.FirstEventPoint.push($scope.ChartDataEvent[i]);
    }
     ...
     // },    
      annotationsOptions: {
        ...
        },
        {
           ...
           var series = $scope.chart2.series[0];
           var series1 = $scope.chart2.series[1];
                    var count = 1;
                    myVar = setInterval(function(){ $scope.PlotPoints() }, 1000);
                    $scope.PlotPoints=function () {   
                                      
                        if(count < $scope.ChartDataEvent.length){
                            series.addPoint({x : $scope.ChartDataCSN[count].x, y: $scope.ChartDataCSN[count].y, eventID : $scope.ChartDataCSN[count].eventID, eventTitle: $scope.ChartDataCSN[count].eventTitle});
                            series1.addPoint({x : $scope.ChartDataEvent[count].x, y: $scope.ChartDataEvent[count].y, eventID : $scope.ChartDataEvent[count].eventID, eventTitle: $scope.ChartDataCSN[count].eventTitle});
                            count++;
                        } else{
                            clearInterval(myVar);
                        } };
          ...
          marker: {
           ...
           var series1 = $scope.chart2.series[1];
                    ...
                    $scope.PlotPoints=function () {   
                        ...
                        if(count < $scope.ChartDataEvent.length){
                            series.addPoint({x : $scope.ChartDataCSN[count].x, y: $scope.ChartDataCSN[count].y});
                            series1.addPoint({x : $scope.ChartDataEvent[count].x, y: $scope.ChartDataEvent[count].y});
                            count++;
                        } else{
                            clearInterval(myVar);
...
//Chart while Refresh
$scope.PlotTimeSeriesforRefresh=function(){
  if(myVar) { clearInterval(myVar); }
    if($scope.position=="AtTimeSeries"){
      if(myVar) { clearInterval(myVar); }
  $scope.PlotESN();
}else if($scope.position=="AtEventChart"){
  if(myVar) { clearInterval(myVar); }
    $scope.PlotEvent($scope.EventSelected);
