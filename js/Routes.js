...
app.config(['$stateProvider', '$urlRouterProvider', 
  ...
  .state("Home", {
    ...
    }) .state("AssetHealthandReliabilityQuickLoad", {
        url: '/AssetHealthandReliabilityQuickLoad',
        templateUrl : "templates/AssetHealthandReliabilityQuickLoad.html",
        controller:"AssetHealthandReliabilityQuickLoadCtrl"
    })
